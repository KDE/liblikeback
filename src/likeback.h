...
public:
     ...
     * @see setWindowNamesListing()
     */
    WindowListing windowNamesListing() const;
...
private:
    LikeBackPrivate *const d_ptr;
    Q_DISABLE_COPY(LikeBack);
    Q_DECLARE_PRIVATE(LikeBack);
    Q_PRIVATE_SLOT(d_ptr, void execCommentDialogFromHelp());
};
