...
{/if}
      ...
      <td><div title="{$comment->date|date_format:"%d-%m-%Y"}, at {$comment->date|date_format:"%T"}"><span class="nobr">{$comment->date|date_format:"%d %b %Y"}</span></div></td>
      <td class="listed-minor">
        <div title="{$comment->fullVersion|escape:'html':'utf-8'}"><span class="nobr">
          {$comment->version|escape:'html':'utf-8'}
        </span></div>
      </td>
      <td class="listed-minor">
        <div title="{$comment->window|escape:'html':'utf-8'}"><span class="nobr">
